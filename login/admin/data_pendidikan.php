...
<html>
<head>
    <title>Tambah Data Pendidikan - Kecamatan Pahandut</title>
...
<body>
    ...
    <div class="container">
        <h2>Tambah Data SKTM Pendidikan</h2>
        <form action="data_pendidikan.php" method="post">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "INSERT INTO sktm_pend (id, no_KK, tanggal, nama_ttl, alamat, ket) VALUES ('$id', '$no_KK', '$tanggal', '$nama_ttl', '$alamat', '$ket')";
