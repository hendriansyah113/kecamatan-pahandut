...
<body>
    ...
    <div class="container">
        ...
        if ($id) {
            ...
            $sql = "
            SELECT * FROM arsip_bpjs WHERE id_arsip_bpjs = $id;
        ";
        ...
        <h2>Data Upload Dokumen <?= $row['nama'] ?></h2>
        <form action="upload_foto_bpjs_process.php?id=<?php echo htmlspecialchars($_GET['id']); ?>" method="post"
    ...
    <div class="container2">
        <h2>Verifikasi</h2>
        <form method="POST" action="verifikasi_bpjs.php?id=<?php echo htmlspecialchars($_GET['id']); ?>">
