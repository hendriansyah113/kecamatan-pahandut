...
<body>
    ...
    <div class="container">
        ...
        <form method="POST"
            action="verifikasi_berobat.php?id=<?php echo htmlspecialchars($_GET['id']); ?>&tabel=<?php echo htmlspecialchars($_GET['tabel']); ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_verifikasi" id="nama_verifikasi" required>
            </div>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $query = "UPDATE $tabel SET verifikasi='Terverifikasi', nama_verifikator='$nama_verifikasi' WHERE id_sktm_berobat='$id'";
