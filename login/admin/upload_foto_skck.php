...
<body>
        ...
        <form action="upload_foto_skck_process.php?id=<?php echo htmlspecialchars($_GET['id']); ?>" method="post"
            ...
            <div class=" form-group">
                ...
                <div>
                    ...
                    if (!empty($row['ktp_path']) && file_exists($ktp_path)) {
            ...
            <div class=" form-group">
                ...
                <div>
                    <?php
                    $kelurahan_path = "uploads/kelurahan/" . $row['kelurahan_path'];
                    if (!empty($row['kelurahan_path']) && file_exists($kelurahan_path)) {
                        echo "<button type='button' class='btn btn-primary' id='openModalButtonKelurahan'>Lihat Dokumen</button>";
                    } else {
                        echo "<span class='text-danger'>Tidak ada dokumen.</span>";
                    }
                    ?>
            ...
            <div class=" form-group">
                ...
                <div>
                    ...
                    if (!empty($row['kk_path']) && file_exists($kk_path)) {
    ...
    <!-- Modal Kelurahan -->
    <div id="viewDocumentModalKelurahan" class="modal">
        <div class="modal-content">
            <span class="close" id="closeModalKelurahan">&times;</span>
            <div id="modalContentKelurahan"></div>
        </div>
    </div>
    ...
    <script>
        ...
        btnKTP.onclick = function() {
            ...
            if (filePath && filePath.endsWith('.pdf')) {
                ...
                modalContentKTP.innerHTML = '<p>Tidak ada dokumen.</p>';
            }
        ...
        // Modal Kelurahan
        var modalKelurahan = document.getElementById("viewDocumentModalKelurahan");
        var btnKelurahan = document.getElementById("openModalButtonKelurahan");
        var spanKelurahan = document.getElementById("closeModalKelurahan");
        var modalContentKelurahan = document.getElementById("modalContentKelurahan");

        btnKelurahan.onclick = function() {
            var filePath = "<?php echo addslashes($kelurahan_path); ?>";
            if (filePath && filePath.endsWith('.pdf')) {
                modalContentKelurahan.innerHTML = '<iframe src="' + filePath +
                    '" style="width:100%; height:500px;" frameborder="0"></iframe>';
            } else if (filePath) {
                modalContentKelurahan.innerHTML = '<img src="' + filePath + '" style="width:100%; height:500px;">';
            } else {
                modalContentKelurahan.innerHTML = '<p>Tidak ada dokumen.</p>';
            }
            modalKelurahan.style.display = "block";
        }

        spanKelurahan.onclick = function() {
            modalKelurahan.style.display = "none";
        }

        window.onclick = function(event) {
            if (event.target == modalKelurahan) {
                modalKelurahan.style.display = "none";
            }
        }
        ...
        btnKK.onclick = function() {
            ...
            if (filePath && filePath.endsWith('.pdf')) {
                ...
                modalContentKK.innerHTML = '<p>Tidak ada dokumen.</p>';
            }
