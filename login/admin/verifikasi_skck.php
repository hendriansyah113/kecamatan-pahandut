...
<body>
    ...
    <div class="container">
        ...
        <form method="POST"
            action="verifikasi_skck.php?id=<?php echo htmlspecialchars($_GET['id']); ?>&tabel=<?php echo htmlspecialchars($_GET['tabel']); ?>">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $query = "UPDATE $tabel SET verifikasi='Terverifikasi', nama_verifikator='$nama_verifikasi' WHERE id_arsip_skck='$id'";
