...
<body>
    ...
    <div class="container">
        ...
        if ($id) {
            ...
            $sql = "SELECT tanggal, nama_ttl, alamat, ket FROM arsip_umum WHERE id = $id";
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "UPDATE arsip_umum SET tanggal='$tanggal', nama_ttl='$nama_ttl', alamat='$alamat', ket='$ket' WHERE id=$id";
